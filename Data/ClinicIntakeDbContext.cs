...
public class ClinicIntakeDbContext : DbContext
{
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        // Delete status history when its parent intake request is deleted.
        modelBuilder
            .Entity<RequestStatusHistory>()
            .HasOne(history => history.IntakeRequest)
            .WithMany(request => request.RequestStatusHistory)
            .HasForeignKey(history => history.IntakeRequestId)
